...
export function createToolDefinitions() {
  return [
    ...
    {
      name: "playwright_set_session_data",
      description: "Set cookies and localStorage for one or more origins before visiting a site",
      inputSchema: {
        type: "object",
        properties: {
          cookies: {
            type: "array",
            description: "Array of cookie objects (see Playwright's addCookies)",
            items: {
              type: "object",
              properties: {
                name: { type: "string" },
          ...
          origins: {
            type: "array",
            description: "Origins and their localStorage items",
            items: {
              type: "object",
              properties: {
                origin: { type: "string" },
